export const copy = {
  appTitle: "Tonalli Memo",
  home: "Inicio",
  feedTitle: "Publicaciones verificadas",
  feedDescription: "Feed de memos Tonalli con verificacion VERIFIED por politica de registro sobre hechos normalizados de Chronik.",
  loading: "Cargando publicaciones...",
  loadingTx: "Cargando transaccion...",
  emptyFeed: "Todavia no hay memos verificados en el indice publico.",
  retry: "Reintentar",
  notFoundTitle: "Pagina no encontrada",
  notFoundBody: "La ruta solicitada no existe en este visor.",
  invalidTxidTitle: "TXID invalido",
